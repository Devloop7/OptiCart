...
export default function LoginPage() {
  ...
  // Show OAuth errors from URL params
  useEffect(() => {
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-700 shadow-sm transition-colors hover:bg-zinc-50 disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-300 dark:hover:bg-zinc-800"
            >
              {googleLoading ? (
